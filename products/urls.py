...
urlpatterns = [
    ...
    path("version/<slug:slug>/edit/", VersionUpdateView.as_view(), name="edit_version"),  # Изменено на slug
    path("version/<slug:slug>/delete/", VersionDeleteView.as_view(), name="delete_version"),  # Изменено на slug
