    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodicity', models.CharField(choices=[('day', 'Ежедневно'), ('week', 'Еженедельно')], default='day', max_length=10, verbose_name='Периодичность')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('success', 'Успешно'), ('failure', 'Неуспешно')], max_length=10, verbose_name='Статус')),
